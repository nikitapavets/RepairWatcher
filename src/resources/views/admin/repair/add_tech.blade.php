        ...
        <div class="col-lg-4">
            <div class="person-info">
                ...
                <label for="person_last_name">
                    <p>Фамилия:</p>
                    <input type="text" id="person_last_name" name="person_second_name" pattern="^[а-яА-Я]+$">
                </label>
                <label for="person_first_name">
                    <p>Имя:</p>
                    <input type="text" id="person_first_name" name="person_first_name" pattern="^[а-яА-Я]+$">
                </label>
                <label for="person_father_name">
                    <p>Отчество:</p>
                    <input type="text" id="person_father_name" name="person_father_name" pattern="^[а-яА-Я]+$">
                </label>
                ...
                <label for="person_tel">
                    <p>Номер телефона:</p>
                    <input type="tel" id="person_tel" name="person_tel" pattern="^375(29|33|44)[0-9]{7}$">
                </label>
            </div>
        </div>
        <div class="col-lg-4">
            <div class="person-info">
                ...
                <label for="product_set">
                    <p>Комплект:</p>
                    <input type="text" id="product_set" name="product_set">
                </label>
                <label for="product_diagnosis">
                    <p>Неисправность:</p>
                    <input type="text" id="product_diagnosis" name="product_diagnosis">
                </label>
            </div>
        </div>
        <div class="col-lg-4">
            <div class="person-info">
                ...
                <label for="info_receipt_number">
                    <p>Номер квитанции:</p>
                    <input type="text" id="info_receipt_number" name="info_receipt_number" pattern="[0-9]+">
                </label>
                <label for="info_date">
                    <p>Дата:</p>
                    <input type="date" id="info_date" name="info_date">
                </label>
